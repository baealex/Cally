...
function Home() {
  ...
  useEffect(() => {
    ...
    ipcRenderer.send('note-load-request', { year, month })
      ...
      {isOpenedNote && (
        <Modal onClose={() => setIsOpenedNote(false)}>
          ...
          <div className="note-content">
            <textarea
              ...
              onChange={(e) => {
                ...
                setNoteData({ ...noteData, [selectedDay.current]: e.target.value })
              }}
            />
          </div>
          <div className="note-buttons">
            ...
            <button onClick={() => {
              ipcRenderer.send('note-save', { year, month, data: noteData })
